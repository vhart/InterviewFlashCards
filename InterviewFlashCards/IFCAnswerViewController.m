...
- (void)displayScoreTrackerAlert {
    ...
    UIAlertController *controller = [UIAlertController alertControllerWithTitle:@"Score Check" message:@"Did you get the question correct?" preferredStyle:UIAlertControllerStyleAlert];
